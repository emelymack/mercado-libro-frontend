            ...
            <SimpleGrid justifyItems='center' mb={20} className={`page ${isScrolling ? 'scroll' : ''}`}>
                ...
                <Table>
                    ...
                    <Tr style={styles.row}>
                        ...
                        <Text fontSize={{ base: "13px", xl: "16px"}}>
                            mail@gmail.com
                            </Text>
                        </Td>
                    </Tr>
                    ...
                    <Tr style={styles.row}>
                        <Td style={styles.rowLineBreakContent}>
                        <Box w={{ base: '30px', xl: '40px'}} h={{ base: '30px', xl: '40px'}} style={styles.icon}>
                            <Image src={TruckIcon} alt="Location icon" w={{ base: '15px', xl: '25px' }} />
                        </Box>
                        <Text fontSize={{ base: "13px", xl: "16px"}}>
                    ...
                    <Tr>
                        <Td style={styles.rowContent}>
                        <Box w={{ base: '30px', xl: '40px'}} h={{ base: '30px', xl: '40px' }} style={styles.icon}>
                            <Image src={CreditCardIcon} alt="Credit card icon" w={{ base: '17px', xl: '25px' }} />
                        </Box>
                        <Text fontSize={{ base: "13px", xl: "16px"}}>
