import { Heading, Image, Text, Table, TableContainer, Tr, Tbody, Td, Box, SimpleGrid, Container } from "@chakra-ui/react";
    ...
    return(
        <>
            <SimpleGrid columns={1} justifyItems='center' mb={20} className={`page ${isScrolling ? 'scroll' : ''}`}>
                ...
                <Container as="table" borderWidth="2px" borderColor="brand.greenLogo" borderRadius="30px" w={{ base: '80vw', lg: '70vw' }}>
                <Table>
                    <Tbody>
                    <Tr style={styles.row}>
