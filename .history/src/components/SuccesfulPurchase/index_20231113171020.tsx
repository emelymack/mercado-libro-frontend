            ...
            <SimpleGrid justifyItems='center' mb={20} className={`page ${isScrolling ? 'scroll' : ''}`}>
                ...
                <Table>
                    ...
                    <Tr style={styles.row}>
                        ...
                        style={styles.icon}>
                            <Image src={EmailIcon} alt="Email icon" w={{ base: '20px', xl: '40px' }} />
                        </Box>
                            mail@gmail.com
                        </Td>
                    </Tr>
                    ...
                    <Tr style={styles.row}>
                        <Td style={styles.rowLineBreakContent}>
                        <Box w={{ base: '20px', xl: '40px'}} h={{ base: '35px', xl: '40px'}} style={styles.icon}>
                            <Image src={TruckIcon} alt="Truck icon" w={{ base: '20px', xl: '30px' }} />
                        </Box>
                    ...
                    <Tr>
                        <Td style={styles.rowContent}>
                        <Box w={{ base: '35px', xl: '40px'}} h={{ base: '35px', xl: '40px' }} style={styles.icon}>
                            <Image src={CreditCardIcon} alt="Credit card icon" w={{ base: '20px', xl: '40px' }} />
                        </Box>
