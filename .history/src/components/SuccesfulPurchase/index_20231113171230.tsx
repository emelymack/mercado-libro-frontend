            ...
            <SimpleGrid justifyItems='center' mb={20} className={`page ${isScrolling ? 'scroll' : ''}`}>
                ...
                <Table>
                    ...
                    <Tr style={styles.row}>
                        ...
                        <Box w={{ sm: '35px', xl: '40px'}} h={{ base: '35px', xl: '40px'}}
                        style={styles.icon}>
                            <Image src={EmailIcon} alt="Email icon" w={{ sm: '20px', xl: '25px' }} />
                        </Box>
                            mail@gmail.com
                        </Td>
                    </Tr>
                    <Tr style={styles.row}>
                        ...
                        <Box w={{ sm: '35px', xl: '40px'}} h={{ sm: '35px', xl: '40px'}} style={styles.icon}>
                            <Image src={LocationIcon} alt="Location icon" w={{ sm: '15px', xl: '20px' }} />
                        </Box>
                            Direccion<br/>
                            CP 1234<br/>
                    ...
                    <Tr style={styles.row}>
                        <Td style={styles.rowLineBreakContent}>
                        <Box w={{ sm: '35px', xl: '40px'}} h={{ sm: '35px', xl: '40px'}} style={styles.icon}>
                            <Image src={TruckIcon} alt="Truck icon" w={{ sm: '20px', xl: '25px' }} />
                        </Box>
                    ...
                    <Tr>
                        <Td style={styles.rowContent}>
                        <Box w={{ sm: '35px', xl: '40px'}} h={{ sm: '35px', xl: '40px' }} style={styles.icon}>
                            <Image src={CreditCardIcon} alt="Credit card icon" w={{ sm: '20px', xl: '25px' }} />
                        </Box>
