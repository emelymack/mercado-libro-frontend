    ...
    return(
        <>
            <SimpleGrid justifyItems='center' mb={20} className={`page ${isScrolling ? 'scroll' : ''}`}>
                <Heading
                    size={"lg"}
                    fontSize={{ base: '30px', sm: '66px', lg: '35px', xl: '40px'}}
                    fontWeight='800'
                    textAlign='center'
                    mt={20}
                    mb={2}
                ...
                <Box w={{ base: '75vw', md: '63vw', lg: '55vw', xl: '39vw' }}>
                    <Text
                    color='#003844'
                ...
                <Table>
                    <Tbody>
                    <Tr style={styles.row}>
                        <Td style={styles.rowContent} p={{ base: "14px", lg: "23px"}} paddingLeft={{ base: "14px", lg: "23px"}} paddingRight={{ base: "5px", lg: "23px"}}>
                    ...
                    <Tr style={styles.row}>
                        <Td style={styles.rowLineBreakContent} paddingLeft={{ base: "14px", lg: "23px"}} paddingRight={{ base: "5px", lg: "23px"}}>
                    ...
                    <Tr>
                        <Td style={styles.rowContent} paddingLeft={{ base: "14px", lg: "23px"}} paddingRight={{ base: "5px", lg: "23px"}}>
                        <Box w={{ base: '35px', xl: '40px'}} h={{ base: '35px', xl: '40px' }} style={styles.icon}>
