import { Grid, GridItem,Heading, Box, Text, SimpleGrid, Button, Spinner, Link, Flex } from "@chakra-ui/react"
            ...
            <Grid w="75vw" templateColumns={{ base: 'repeat(1, 1fr)', md: 'repeat(5, 1fr)'}} gap={4} pt='20px'>
                ...
                <GridItem colSpan={3} p='10px' borderRadius='md'>
                    ...
                    invoices.length > 0 ? (
                        ...
                        {/* Icono grande al costado */}
                        <Icon as={FaIcon} boxSize={8} />
                  
                        {/* Texto 1 arriba del icono */}
                        <Box>
                          <Text fontWeight="bold">Texto 1</Text>
                          <Text>Contenido del Texto 1</Text>
                        </Box>
                  
                        {/* Texto 2 debajo del icono */}
                        <Box>
                          <Text fontWeight="bold">Texto 2</Text>
                          <Text>Contenido del Texto 2</Text>
                        </Box>
                      </Flex>
                    )
