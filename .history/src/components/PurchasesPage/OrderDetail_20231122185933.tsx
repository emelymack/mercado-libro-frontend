    ...
    return(
        <Flex w='min-content' m='0 auto' pt={{base: '13vh', lg: '18vh'}} pb={{base: '8vh', '2xl': '8vh'}} flexDir={"column"} alignItems={"center"}>
            <Box alignSelf='flex-start' mb='10px'>
                <BreadcrumbNav order='Orden #3424' size={{ base: 'sm', sm: 'xs', lg: 'sm'}}/>
            </Box>
            <Heading alignSelf='flex-start' fontSize={{ base: 'lg', lg: '2xl', '2xl': '3xl'}}>Orden #3424</Heading>
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(1, 1fr)' templateColumns={{ base: 'repeat(2, 1fr)', sm: 'repeat(7, 1fr)', '@media screen and (max-width: 720px) and (min-width: 480px)': {
          templateColumns: 'repeat(3, 1fr)',
        }}} gap={4} mt='10px'
            >
                <GridItem rowSpan={2} colSpan={2} h='min-content'>
                    <Text fontSize={{ base: 'md', sm: 'md', lg: 'lg', '2xl': 'lg'}} pb='5px' borderBottom='1px solid #e6e6e6'>Detalles</Text>
                    <Box display='flex' alignItems='center' m='5px 0'>
                      <Image boxSize={4} src={CalendarIcon} mr='8px' alt="Calendar icon"/>
                      <Text fontSize={{ base: 'sm', sm: 'xs', lg: 'sm', xl: 'md', '2xl': 'md'}}>Fecha: <b>31/03/2023</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center' m='5px 0'>
                      <Image boxSize={4} src={InfoIcon} mr='8px' alt="Info icon"/>
                      <Text fontSize={{ base: 'sm', sm: 'xs', lg: 'sm', xl: 'md', '2xl': 'md'}}>Estado: <b>Cerrada</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center' m='5px 0'>
                      <Image boxSize={4} src={CardIcon} mr='8px' alt="Card icon"/>
                      <Text fontSize={{ base: 'sm', sm: 'xs', lg: 'sm', xl: 'md', '2xl': 'md'}}>Pago: <b>Pagado</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center' m='5px 0'>
                      <Image boxSize={4} src={DollarIcon} mr='8px' alt="Dollar icon"/>
                      <Text fontSize={{ base: 'sm', sm: 'xs', lg: 'sm', xl: 'md', '2xl': 'md'}}>Medio de pago: <b>Mercado Pago</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center' m='5px 0'>
                      <Image boxSize={4} src={TruckIcon} mr='8px' alt="Truck icon"/>
                      <Text fontSize={{ base: 'sm', sm: 'xs', lg: 'sm', xl: 'md', '2xl': 'md'}}>Envío: <b>Enviado</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center' m='30px 0 5px 0'>
                        <Image boxSize={4} src={LocationIcon} mr='8px' alt="Location icon"/>
                        <Text fontWeight='semibold' fontSize={{base: 'md', sm: 'sm', lg: 'sm', xl: 'md', '2xl': 'md'}}>Dirección de envío:</Text>
                    </Box>
                    <Text fontSize={{ base: 'sm', sm: 'xs', lg: 'sm', xl: 'md', '2xl': 'md'}}>
