import { Grid, Text, Box, GridItem, Heading, Table, Thead, Tr, Th, Tbody, Td, Image, Flex} from "@chakra-ui/react"
            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(2, 1fr)' templateColumns={{ base: 'repeat(2, 1fr)', lg: 'repeat(7, 1fr)'}} gap={4} mt='15px'>
                ...
                <GridItem colSpan={5}>
                    ...
                    <Thead borderBottom='1px solid #e6e6e6'>
                        <Tr>
                            <Th p='0 0 20px 0' w={{ base: '200px', md: '200px', lg: '270px', xl: '350px', '2xl': '450px'}} fontWeight='semibold' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} textTransform='capitalize'>Producto</Th>
                            <Th p='0 0 20px 0' w='min-content' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th p='0 0 20px 0' w='min-content' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
                            <Th p='0 0 20px 0' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Total</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
                        <Tr>
                            <Td p='20px 0 0 0' display='flex'>
                                ...
                                <Text ml='20px' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}}  fontWeight='semibold'>COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</Text>
                            </Td>
                            <Td p='20px 0 0 0' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>$24.900</Td>
                            <Td p='20px 0 0 0' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>1</Td>
                            <Td p='20px 0 0 0' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>$24.900</Td>
                        </Tr>
                    </Tbody>
                    </Table>
