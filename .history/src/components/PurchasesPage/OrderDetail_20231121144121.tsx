...
const OrderDetail = () => {
    ...
    return(
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w={{ lg: '80vw', xl: '80vw', '2xl': '65vw'}} templateRows='repeat(2, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
                ...
                <GridItem colSpan={5} bg='tomato'>
                    ...
                    <Thead borderBottom='1px solid #e6e6e6'>
                        <Tr>
                            <Th p={{ lg: '0 70px 0 0', xl: '0 20px 0 0', '2xl': '0 20px 0 0'}} w='450px' fontWeight='semibold' fontSize='lg' textTransform='capitalize'>Producto</Th>
