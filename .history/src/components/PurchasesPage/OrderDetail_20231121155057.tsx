...
const OrderDetail = () => {
    ...
    return(
        <Flex w='min-content' m='0 auto' pt={60} pb={40} flexDir={"column"} alignItems={"center"} flexWrap='wrap'>
            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(auto-fill, 1fr)' templateColumns='repeat(auto-fill, 1fr)' gap={4} mt='15px'>
