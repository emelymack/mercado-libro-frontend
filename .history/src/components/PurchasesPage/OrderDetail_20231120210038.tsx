                ...
                <GridItem colSpan={5} bg='tomato'>
                    ...
                    <Tbody>
                        <Tr>
                            ...
                            <Td p='20px 0 0 0' w='20%' verticalAlign='top' >$24.900</Td>
                            <Td p='20px 0 0 0' w='20%' verticalAlign='top' textAlign='center'>1</Td>
                            <Td p='20px 0 0 0' w='20%' verticalAlign='top' textAlign='center'>$24.900</Td>
                        </Tr>
                        <Tr>
