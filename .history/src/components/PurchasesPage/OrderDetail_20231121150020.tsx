            ...
            <Grid w='65vw' templateRows='repeat(2, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
                ...
                <GridItem colSpan={5} bg='tomato'>
                    ...
                    <Thead borderBottom='1px solid #e6e6e6'>
                        <Tr>
                            <Th p='0 0 20px 0' w={{ lg: '300px', xl: '350px', '2xl': '450px'}} fontWeight='semibold' fontSize={{ xl: 'md', '2xl': 'lg'}} textTransform='capitalize'>Producto</Th>
                            <Th p='0 0 20px 0' w='min-content' fontSize={{ lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th p='0 0 20px 0' w='min-content' fontSize={{ lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
                            <Th p='0 0 20px 0' fontSize={{ lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Total</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
                        <Tr>
                            <Td p='20px 0 0 0' display='flex'>
                                <Image boxSize={{ lg: '80px', xl: '100px', '2xl': '120px'}} src='https://acdn.mitiendanube.com/stores/944/405/products/photo_2023-04-22_06-58-22-21-11e33180d060b8f66d16821838879699-320-0.webp'/>
                                <Text ml='20px' fontSize={{ lg: 'sm', xl: 'md', '2xl': 'lg'}}  fontWeight='semibold'>COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</Text>
                            </Td>
                            <Td p='20px 0 0 0' fontSize={{ lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>$24.900</Td>
                            <Td p='20px 0 0 0' fontSize={{ lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>1</Td>
                            <Td p='20px 0 0 0' fontSize={{ lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>$24.900</Td>
                        </Tr>
                        <Tr>
                            <Td p='20px 0 0 0' display='flex'>
                                <Image boxSize={{ lg: '100px', xl: '100px', '2xl': '120px'}} src='https://acdn.mitiendanube.com/stores/944/405/products/photo_2023-04-22_06-58-22-21-11e33180d060b8f66d16821838879699-320-0.webp'/>
