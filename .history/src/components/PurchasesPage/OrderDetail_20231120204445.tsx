                ...
                <GridItem colSpan={4} bg='tomato' w='min-content'>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th p='0' pr='100px' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Precio</Th>
                            <Th p='0' pr='100px' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Cantidad</Th>
                    ...
                    <Tbody>
                        <Tr>
                            ...
                            <Td p='20px 100px 0 0' verticalAlign='top' >$24.900</Td>
                            <Td p='20px 100px 0 0' verticalAlign='top' textAlign='center' w='min-content'>1</Td>
