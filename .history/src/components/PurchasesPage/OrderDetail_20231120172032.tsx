        ...
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w='80vw' templateRows='repeat(2, 1fr)' templateColumns='repeat(5, 1fr)' gap={4}>
                ...
                <GridItem colSpan={3} bg='tomato'>
                    ...
                    <Thead>
                        <Tr>
                            <Th p='0' w='450px' fontSize='lg' textTransform='capitalize'>Producto</Th>
                            <Th p='0' fontSize='lg' textTransform='capitalize' isNumeric>Precio</Th>
                            <Th p='0' fontSize='lg' textTransform='capitalize' isNumeric>Cantidad</Th>
                            <Th p='0' fontSize='lg' textTransform='capitalize' isNumeric>Total</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
                        <Tr>
