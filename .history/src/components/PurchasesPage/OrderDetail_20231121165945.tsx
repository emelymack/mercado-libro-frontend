                    ...
                    <Tbody>
                        <Tr>
                            <Td p='20px 0 0 0' display='flex' overflowWrap='anywhere'>
                                ...
                                <Text ml='20px' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} overflowWrap='break-word' fontWeight='semibold'>COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</Text>
                            </Td>
