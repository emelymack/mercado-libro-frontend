                ...
                <GridItem colSpan={4} bg='tomato' w='min-content'>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th p='0' w='20%' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Precio</Th>
                            <Th p='0' w='20%' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Cantidad</Th>
