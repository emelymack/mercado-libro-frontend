                ...
                <Tbody>
                    <Tr>
                        <Td display='flex'>
                            ...
                            <Text ml='20px' fontSize={{base: 'sm', '2xl': 'md'}} whiteSpace="normal" wordBreak="break-word" fontWeight='semibold'>Harry Potter y La Orden Del Fenix: Edicion Minalima, J.K Rowling</Text>
                        </Td>
