...
const OrderDetail = () => {
  const size = useWindowSize();
    ...
    return(
        <Flex h='100vh' w='min-content' m='0 auto' pt={{base: '13vh', lg: '20vh'}} pb={{base: '8vh', '2xl': '2vh'}} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(2, 2fr)' templateColumns={{ base: 'repeat(2, 1fr)', lg: 'repeat(7, 1fr)'}} gap={4} mt='10px'>
                <GridItem rowSpan={2} colSpan={2} h='min-content' bg='tomato'>
                    ...
                    <GridItem colSpan={2} rowStart={2} h='min-content' bg='tomato'>
                ...
                <GridItem colSpan={5} colStart={3} mb='10px' mt='10px'>
