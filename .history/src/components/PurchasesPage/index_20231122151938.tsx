...
export const PurchasesPage = () => {
    ...
    return (
        <Box m='0 auto' w='min-content' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"} >
            <Box alignSelf='flex-start' mb='10px'>
                <BreadcrumbNav size={{ base: 'sm', lg: 'sm'}}/>
            </Box>
            <Heading alignSelf='flex-start' fontSize={{ base: 'xl', lg: '2xl', '2xl': '3xl'}}>
                Mi cuenta
            </Heading>
                ...
                <GridItem rowSpan={4} colSpan={2} p='10px' borderRadius='md'>
                    ...
                    <Grid templateRows='repeat(2, 1fr)' gap={4} pt='15px'>
                        ...
                        <Box display='flex' justifyContent="space-between">
                            ...
                            <Box as="button" fontWeight='semibold' fontSize={{base: '14px', xl: 'sm'}}  _hover={{ opacity: '0.6', transition: 'opacity 0.4s ease-in-out' }}>
                                Editar
                            </Box>
                        </Box>
                        <hr/>
