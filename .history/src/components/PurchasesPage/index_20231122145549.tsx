...
export const PurchasesPage = () => {
    ...
    return (
        <Box pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"} >
            <Box alignSelf='flex-start' ml='13vw' mb='10px'>
                <BreadcrumbNav/>
            </Box>
            <Heading alignSelf='flex-start' ml='13vw'>
                Mi cuenta
            </Heading>
            <Grid w="75vw" templateRows='repeat(2, 1fr)' templateColumns={{ base: 'repeat(1, 1fr)', lg: 'repeat(5, 1fr)'}} gap={4} pt='20px'>
