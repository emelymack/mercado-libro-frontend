                ...
                <GridItem colSpan={5} pb='20px' borderBottom='1px solid #e6e6e6'>
                    ...
                    <Thead borderBottom='1px solid #e6e6e6'>
                        <Tr>
                            ...
                            <Th p='0 0 20px 0' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th p='0 0 20px 0' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
