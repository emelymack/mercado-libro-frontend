    ...
    return(
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w='65vw' templateRows='repeat(2, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
                <GridItem rowSpan={2} colSpan={2} h='min-content' display='flex' flexDir='column' justifyContent='space-between'>
                    ...
                    <Box display='flex' alignItems='center'>
                      <Image boxSize={4} src={InfoIcon} mr='8px' alt="Calendar icon"/>
                      <Text>Estado: <b>Cerrada</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center'>
                      <Image boxSize={4} src={CardIcon} mr='8px' alt="Calendar icon"/>
                      <Text>Pago: <b>Pagado</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center'>
                      <Image boxSize={4} src={DollarIcon} mr='8px' alt="Calendar icon"/>
                      <Text>Medio <b>de pago: Mercado Pago</b></Text>
                    </Box>
                    <Box display='flex' alignItems='center'>
                      <Image boxSize={4} src={TruckIcon} mr='8px' alt="Calendar icon"/>
