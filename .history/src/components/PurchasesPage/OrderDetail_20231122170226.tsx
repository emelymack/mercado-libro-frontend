  ...
  const size = useWindowSize();
    ...
    return(
        <Flex w='min-content' m='0 auto' pt={{base: '13vh', lg: '20vh'}} pb={{base: '8vh', '2xl': '2vh'}} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(5, 1fr)' templateColumns={{ base: 'repeat(7, 1fr)', lg: 'repeat(7, 1fr)'}} gap={4} mt='10px'>
                <GridItem colSpan={{ base: 2, lg: 2}} colStart={{ base: 2, lg: 1}} rowStart={1} h='min-content' bg='tomato'>
                    ...
                    <GridItem colSpan={3} colStart={{ base: 4, lg: 1}} rowStart={{ base: 2, lg: 2}} h='min-content' bg='tomato'>
                    ...
                    <Text fontSize={{ base: 'sm', lg: 'sm', xl: 'md', '2xl': 'md'}}>
                      ...
                      {size.width && size.width > 980 && (
                        `
                        Rocio Belen Ghillino
                        José de San Martin 654 14A
                        Quilmes Quilmes, 1878
                        Gran Buenos Aires
                        Argentina
                        `
                      )}
