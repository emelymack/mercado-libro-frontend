        ...
        <Flex w='min-content' m='0 auto' pt={60} pb={40} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(2, 1fr)' templateColumns={{ base: 'repeat(2, 1fr)', lg: 'repeat(7, 1fr)'}} gap={4} mt='15px'>
                ...
                <GridItem colSpan={5} h='min-content' display='flex' flexDir='column'>
                    <Text fontSize={{ base: 'sm', lg: 'md', xl: 'lg', '2xl': 'lg'}}><b>Costo de envío (Correo Argentino - Envio a domicilio):</b> Gratis</Text>
                    <Text fontSize={{ base: 'sm', lg: 'md', xl: 'lg', '2xl': 'lg'}}><b>Subtotal:</b> $24.900</Text>
                    <Text fontSize={{ base: 'sm', lg: 'md', xl: 'lg', '2xl': 'lg'}} fontWeight='semibold' alignSelf='center'>Total: $24.900</Text>
                </GridItem>
            </Grid>
        </Flex>
    )
