    ...
    return(
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"} boxSizing='border-box'>
            ...
            <Grid w='80vw' templateRows='repeat(1, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
                ...
                <GridItem colSpan={4} bg='tomato' w='min-content'>
                    <Text fontSize='xl'>Productos</Text>
                    <Table variant='unstyled' mt='30px'>
                    <Thead>
                        <Tr>
                            <Th p='0' pr='350px' fontWeight='semibold' fontSize='lg' textTransform='capitalize'>Producto</Th>
                            <Th p='0' pr='50px' pl='50px' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Precio</Th>
                            <Th p='0' pr='50px' pl='50px' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Cantidad</Th>
                            <Th p='0' pr='50px' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Total</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
                        <Tr>
                            ...
                            <Td p='20px 0 0 0' verticalAlign='top' textAlign='center' w='min-content'>1</Td>
