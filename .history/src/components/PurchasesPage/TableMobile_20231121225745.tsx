    ...
    return(
        <TableContainer>
            <Table>
                <Thead>
                    <Tr>
                        <Th fontWeight='semibold' fontSize={{base: 'xl'}} textTransform='capitalize'>Producto</Th>
                    </Tr>
                </Thead>
                <Tbody>
                    <Tr>
                        <Td display='flex'>
                            ...
                            <Text color='black' ml='20px' fontSize={{base: 'sm', '2xl': 'lg'}} whiteSpace="normal" wordBreak="break-word"><b>COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</b> x1</Text>
                        </Td>
