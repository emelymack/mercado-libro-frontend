...
const OrderDetail = () => {
    ...
    return(
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w='80vw' templateRows='repeat(1, 1fr)' templateColumns='repeat(5, 1fr)' gap={4}>
                ...
                <GridItem colSpan={3} bg='tomato'>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th p='0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' isNumeric>Precio</Th>
                            <Th p='0' fontSize='lg' fontWeight='semibold' textTransform='capitalize' isNumeric>Cantidad</Th>
                            <Th p='0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' isNumeric>Total</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
                        <Tr>
                            <Td p='20px 0 0 0' display='flex'>
                                ...
                                <Text ml='20px'> COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</Text>
                            </Td>
                            <Td p='20px 0 0 0' verticalAlign='top' w='min-content'>$24.900</Td>
                ...
                <GridItem colSpan={3} colStart={2} colEnd={5} bg='tomato'>
