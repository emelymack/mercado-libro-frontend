...
const OrderDetail = () => {
  const size = useWindowSize();
    ...
    return(
        <Flex w='min-content' m='0 auto' pt={{base: '20', lg: '40', xl: '40'}} pb={20} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(5, 1fr)' templateColumns={{ base: 'repeat(2, 1fr)', lg: 'repeat(7, 1fr)'}} gap={4} mt='10px'>
