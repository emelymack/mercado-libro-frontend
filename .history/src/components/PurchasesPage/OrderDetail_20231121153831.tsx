...
const OrderDetail = () => {
    ...
    return(
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"}>
            ...
            <Heading alignSelf='flex-start' fontSize={{ lg: '2xl', '2xl': '6xl'}}>Orden #3424</Heading>
            <Grid w={{ lg: '80vw', '2xl': '65vw'}} templateRows='repeat(2, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
