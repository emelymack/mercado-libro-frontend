                ...
                <GridItem colSpan={5} bg='tomato'>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th p='0' w='25%' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Precio</Th>
                            <Th p='0' w='25%'fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center' isNumeric>Cantidad</Th>
