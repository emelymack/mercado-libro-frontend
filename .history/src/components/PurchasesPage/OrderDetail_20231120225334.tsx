...
const OrderDetail = () => {
    ...
    return(
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} justifyContent={"center"}>
            <Heading alignSelf='flex-start'>Orden #3424</Heading>
            <Grid w='80vw' templateRows='repeat(2, 1fr)' templateColumns='repeat(9, 1fr)' gap={4} mt='15px'>
                <GridItem rowSpan={2} colSpan={2} bg='tomato' h='min-content'>
                ...
                <GridItem colSpan={5} bg='tomato'>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th p='0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th p='0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
                            <Th p='0' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Total</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
                        <Tr>
                ...
                <GridItem colSpan={5} bg='tomato' h='min-content'>
