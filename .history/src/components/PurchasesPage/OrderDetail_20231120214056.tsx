                ...
                <GridItem w='min-content' colSpan={5} h='min-content' bg='tomato'>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th p='0 100px 0 0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th p='0 100px 0 0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
