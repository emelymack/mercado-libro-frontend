        ...
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"} boxSizing='border-box'>
            ...
            <Grid w='80vw' templateRows='repeat(1, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
                ...
                <GridItem colSpan={5} bg='tomato'>
                    ...
                    <Thead>
                        <Tr>
                            <Th p='0' w='300px' fontWeight='semibold' fontSize='lg' textTransform='capitalize'>Producto</Th>
                            <Th p='0' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th p='0' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
