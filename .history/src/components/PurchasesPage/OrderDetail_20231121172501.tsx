                    ...
                    <Tbody>
                        <Tr>
                            <Td display='flex'>
                                ...
                                <Text ml='20px' fontSize='lg' whiteSpace="normal" wordBreak="break-word" fontWeight='semibold'>COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</Text>
                            </Td>
                            <Td fontSize='lg' verticalAlign='top' textAlign='center'>$24.900</Td>
                            <Td fontSize='lg' verticalAlign='top' textAlign='center'>1</Td>
                            <Td fontSize='lg' verticalAlign='top' textAlign='center'>$24.900</Td>
                        </Tr>
                    </Tbody>
                    </Table>
