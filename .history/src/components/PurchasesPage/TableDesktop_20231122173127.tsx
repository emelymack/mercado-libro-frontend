        ...
        <TableContainer>
            <Table>
                ...
                <Tbody>
                    <Tr>
                        <Td display='flex'>
                            <Image objectFit='cover' boxSize={{ base: '50px', md: '50px', lg: '80px', xl: '100px', '2xl': '120px'}} src='https://www.antena3.com/newa3flash/modulos_blancos/uploader/uploads/Destroza%20este%20diario.jpg'/>
                    ...
                    <Tr>
                        <Td display='flex'>
                            <Image objectFit='cover' boxSize={{ base: '50px', md: '50px', lg: '80px', xl: '100px', '2xl': '120px'}} src='https://m.media-amazon.com/images/I/51gVtiVGL5L._SL500_.jpg'/>
