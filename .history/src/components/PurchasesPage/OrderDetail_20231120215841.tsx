    ...
    return(
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w='80vw' templateRows='repeat(1, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
                ...
                <GridItem w='min-content' colSpan={5} h='min-content' bg='tomato'>
                    <Text fontSize='xl'>Productos</Text>
                    <Table variant='unstyled' mt='30px'>
                    <Thead>
                        <Tr>
                            <Th p='0 500px 0 0' w='450px' fontWeight='semibold' fontSize='lg' textTransform='capitalize'>Producto</Th>
                            <Th p='0 50px 0 0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th p='0 50px 0 0' w='min-content' fontSize='lg' fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
