            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} templateRows='repeat(2, 1fr)' templateColumns={{ base: 'repeat(2, 1fr)', lg: 'repeat(7, 1fr)'}} gap={4} mt='15px'>
                ...
                <GridItem colSpan={5} pb='20px' borderBottom='1px solid #e6e6e6'>
                    ...
                    <Thead borderBottom='1px solid #e6e6e6'>
                        <Tr>
                            <Th w={{ base: '200px', md: '200px', lg: '270px', xl: '350px', '2xl': '450px'}} fontWeight='semibold' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} textTransform='capitalize'>Producto</Th>
                    ...
                    <Tbody>
                        <Tr>
                            <Td p='20px 0 0 0' display='flex' overflowWrap='anywhere'>
                                ...
                                <Text ml='20px' fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} whiteSpace="normal" wordBreak="break-word" fontWeight='semibold'>COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</Text>
                            </Td>
