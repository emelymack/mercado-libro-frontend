  ...
  const size = useWindowSize();
    ...
    return(
        <Flex w='min-content' m='0 auto' pt={{base: '13vh', lg: '20vh'}} pb={{base: '8vh', '2xl': '2vh'}} flexDir={"column"} alignItems={"center"}>
            ...
            <Grid w={{ base: '85vw', '2xl': '65vw'}} gridTemplateRows={'200px 1fr 30px'} templateColumns={{ base: 'repeat(2, 1fr)', lg: 'repeat(7, 1fr)'}} gap={4} mt='10px'>
                ...
                <GridItem colSpan={5} colStart={1} rowStart={2} mb='10px' mt='10px'>
