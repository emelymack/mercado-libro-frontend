        ...
        <Box w='min-content' m='0 auto' pt={60} pb={40} display={"flex"} flexDir={"column"} alignItems={"center"} boxSizing='border-box'>
            ...
            <Grid w='80vw' templateRows='repeat(1, 1fr)' templateColumns='repeat(7, 1fr)' gap={4} mt='15px'>
                ...
                <GridItem colSpan={5} bg='tomato'>
                    ...
                    <Thead>
                        <Tr>
                            <Th p='0' pb='30px' fontWeight='semibold' fontSize='lg' textTransform='capitalize'>Producto</Th>
                    ...
                    <Tbody>
                        <Tr>
                            ...
                            <Td p='0' verticalAlign='top' >$24.900</Td>
                            <Td p='0' verticalAlign='top' textAlign='center'>1</Td>
                            <Td p='0' verticalAlign='top' textAlign='center'>$24.900</Td>
                        </Tr>
                        <Tr>
