                ...
                <GridItem colSpan={5} pb='20px' borderBottom='1px solid #e6e6e6'>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th fontSize={{ base: 'xs', lg: 'sm', xl: 'lg', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Precio</Th>
                            <Th fontSize={{ base: 'xs', lg: 'sm', xl: 'lg', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Cantidad</Th>
                            <Th fontSize={{ base: 'xs', lg: 'sm', xl: 'lg', '2xl': 'lg'}} fontWeight='semibold' textTransform='capitalize' textAlign='center'>Total</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
                        <Tr>
                            ...
                            <Td fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>$24.900</Td>
                            <Td fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>1</Td>
                            <Td fontSize={{ base: 'xs', lg: 'sm', xl: 'md', '2xl': 'lg'}} verticalAlign='top' textAlign='center'>$24.900</Td>
                        </Tr>
                    </Tbody>
                    </Table>
