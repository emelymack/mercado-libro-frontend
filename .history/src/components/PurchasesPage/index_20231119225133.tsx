                ...
                <GridItem rowSpan={4} colSpan={2} p='10px' borderRadius='md'>
                    ...
                    <Grid templateRows='repeat(2, 1fr)' gap={4} pt='15px'>
                        ...
                        <Box display='flex' justifyContent="space-between">
                            ...
                            <Box as="button" fontWeight='semibold' _hover={{ transition: 'opacity 0.5s ease-in-out' }}>
                                Editar
                            </Box>
                        </Box>
                        <hr/>
                        ...
                        <Box display='flex' justifyContent="space-between">
                            ...
                            <Box as="button" fontWeight='semibold' _hover={{ color: "grey", transition: "color .4s ease-in-out" }}>
                                Editar
                            </Box>
                        </Box>
                        <hr/>
                            ...
                            <Box as="button" fontSize='sm' fontWeight='bold' mt='10px' _hover={{ color: "grey", transition: "color .4s ease-in-out" }}>
                                Otras direcciones
                            </Box>
                        </GridItem>
                    </Grid>
