                    ...
                    <Tbody>
                        <Tr>
                            <Td display='flex'>
                                ...
                                <Text ml='20px' fontSize={{base: 'sm', '2xl': 'lg'}} whiteSpace="normal" wordBreak={{ base:'normal', '2xl': "break-word"}} fontWeight='semibold'>COLOR WOW - PRE ORDER | DREAM COAT SPRAY ANTI FRIZZ 200ml</Text>
                            </Td>
