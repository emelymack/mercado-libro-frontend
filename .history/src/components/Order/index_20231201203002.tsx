...
const Order = () => {
  ...
  const shippingMethod = invoice?.shipping_method === 'CORREO_ARGENTINO' ? <b>Costo de envío (Correo Argentino - Envio a domicilio):</b> + `$${invoice?.shipping}` : `Costo de envío (retiro en sucursal RECOLETA): $0`;
