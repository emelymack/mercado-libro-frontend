...
const Order = () => {
  ...
  const shippingMethod = invoice?.shipping_method === 'CORREO_ARGENTINO' ? `Costo de envío (Correo Argentino - Envio a domicilio): ${invoice?.shipping}` : `Costo de envío (retiro en sucursal RECOLETA): $0`;
