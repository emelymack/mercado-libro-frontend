...
const TableDesktop = ({ items }: { items: Book[] }) => {
                ...
                <Tbody>
                    {items.map((item) => (
                         ...
                         <Td display='flex'>
                             ...
                             <Text ml='20px' fontSize={{base: 'sm', '2xl': 'md'}} whiteSpace="normal" wordBreak="break-word" fontWeight='semibold'>{item.title}, {item.authors[0].name}</Text>
                         </Td>
