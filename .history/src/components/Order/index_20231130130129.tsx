...
const Order = () => {
  ...
  const selectedInvoiceId = useSelector((state) => state.invoice.selectedInvoiceId);
    ...
    return(
        <Flex w='min-content' m='0 auto' pt={{base: '13vh', lg: '18vh'}} pb={{base: '8vh', '2xl': '8vh'}} flexDir={"column"} alignItems={"center"}>
            ...
            <Heading alignSelf='flex-start' fontSize={{ base: 'xl', lg: '2xl', '2xl': '3xl'}}>Orden #{selectedInvoiceId}</Heading>
